...
# Internal version
LINEAGE_VERSION := Sigma$(SIGMA_VARIANT)-v$(SIGMA_VERSION)-$(shell date +%Y%m%d)-$(SIGMA_BUILD_TYPE)-$(SIGMA_BUILD_PACKAGE)-$(SIGMA_BUILD)

# Display version
LINEAGE_DISPLAY_VERSION := Sigma$(SIGMA_VARIANT)-v$(SIGMA_VERSION)-$(SIGMA_BUILD_PACKAGE)-$(SIGMA_BUILD)
